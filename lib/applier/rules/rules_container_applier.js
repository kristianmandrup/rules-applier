...
(function(){
  var apply, util, camelCase, Debugger, StaticApplier, DynamicApplier, ExecutionContext, ContainerRulesApplier, toString$ = {}.toString;
  apply = require('../apply');
  ...
  module.exports = ContainerRulesApplier = (function(){
    ContainerRulesApplier.displayName = 'ContainerRulesApplier';
    var prototype = ContainerRulesApplier.prototype, constructor = ContainerRulesApplier;
    importAll$(prototype, arguments[0]);
    function ContainerRulesApplier(ctx, accessRequest, debugging){
      this.ctx = ctx;
