...
(function(){
  ...
  util = require('../rule/util');
  utily = require('../util/index');
  subject = utily.subject;
  Debugger = utily.Debugger;
  RuleApplier = require('./../rule/applier/single/index').RuleApplier;
  ExecutionContext = require('./../rule/applier/execution_context');
